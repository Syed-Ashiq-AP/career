...
export default function Page() {
    ...
    return (
        <div className="h-full not-prose relative flex w-full flex-col gap-16 overflow-hidden px-4 py-24 text-center sm:px-8">
            ...
            <div className="flex flex-col items-center justify-center gap-8">
                <div className="flex flex-col items-center space-y-2">
                    ...
                    >
                        Start with free AI career guidance, or unlock
                        personalized career assessment for deeper insights.
                    </motion.p>
                </div>
