...
export default function QuestionPagination({
    ...
    const getButtonStyle = (isActive: boolean) => {
        ...
        // Default variant
        return isActive ? "bg-primary text-primary" : "hover:bg-muted";
    };
            ...
            <div className="mx-auto max-w-6xl px-4 py-12">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-muted-foreground mx-auto max-w-2xl">
                        Interactive pagination components that demonstrate real
                        content navigation. Each example shows how pagination
                        can be used to navigate through a collection of items.
                    </p>
                </div>
